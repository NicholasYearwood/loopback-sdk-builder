...
module.exports = function generate(ctx) {
  ...
  **/
  let schema = [
     ...
     */
    {
      template: './../templates/shared/services/custom/apis.ejs',
      output: '/services/custom/SDKApis.ts',
      params: {
        models: ctx.models,
        isTyped: ctx.isTyped,
  ...
  function buildModuleImports(models, isIo, driver) {
    let imports = [
      ...
      { module: 'SDKApis', from: './services/custom/SDKApis'},
  ...
  function buildNgModuleImports(models, environment, isIo, driver) {
    let imports = ['LoopBackAuth', 'LoggerService', 'SDKModels', 'SDKApis'];
  ...
  function buildBaseServiceImports(isIo) {
    let imports = [
      ...
      { module: 'SDKApis', from: '../custom/SDKApis'},
      { module: 'Observable, Subject', from: 'rxjs' },
